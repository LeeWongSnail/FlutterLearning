...
class CustomRouterAnimation extends PageRouteBuilder {
  final Widget widget;

  // CustomRouterAnimation(this.widget):  super (
...
CustomRouterAnimation(this.widget):  super (
    ...
    transitionsBuilder:(BuildContext context, Animation<double> animation1, Animation<double> animation2, Widget child) {
      ...
      // return RotationTransition(turns: Tween(begin: 0.0, end: 1.0).animate(CurvedAnimation(parent: animation1, curve: Curves.fastOutSlowIn)), child: ScaleTransition(
      ...
      ).animate(CurvedAnimation(parent: animation1, curve: Curves.linear)),child: child,);
    },
  );
}